...
const About = () => {
  ...
  const skills = ['JavaScript', 'TypeScript', 'React', 'Node.js', 'Java', 'Spring', 'SpringBoot', 'Python', 'Django', 'C++', 'SQL'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
            Hello! My name is Andrew, and I am passionate about software development
            I began my journey in web development in 2020 when I created some simple 
            games from scratch. This experience sparked my interest and set me on the 
            path to pursuing software development.
            </p>

            <p>
              Fast-forward to today, and I’ve had the privilege of working at{' '}
              <a href="https://www.vinai.io/">a top 20 AI company</a>,{' '}
